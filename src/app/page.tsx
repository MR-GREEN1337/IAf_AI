      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <a href="/a-propos"><li><button onClick={() => document.getElementById('about')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-pink-300 transition-colors">{t.about}</button></li></a>
            <li><button onClick={() => document.getElementById('events')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-pink-300 transition-colors">{t.events}</button></li>
            <li><button onClick={() => document.getElementById('partners')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-pink-300 transition-colors">{t.partners}</button></li>
            <li><button onClick={() => document.getElementById('news')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-pink-300 transition-colors">{t.news}</button></li>
          </ul>
        </div>
